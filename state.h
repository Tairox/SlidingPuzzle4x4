...
namespace Engine //Can be reused for other games
{
    ...
    public:
        ...
        virtual void Update(sf::Time deltaTime) = 0; //Update elements, l'argument sera utilisé pour faire tourner le jeu a 60fps
        virtual void Draw() = 0;
